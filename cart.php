          	...
          	<div class="row" id="detailInv">
				    	...
				    	<?php 
					      ...
					      $totalPrice +=$pricePerfect;
					       ...
					       ?>
					       	...
					       	<tr>
					       		<!-- <td colspan="3">Tổng thanh toán: <span class="total2"><?php echo number_format($totalPrice) ?></span> </td> -->
          			...
          			<div class="modal-dialog modal-lg" role="document">
          				<div class="modal-content">
          					...
          					<div class="modal-body">
								<h5 class="errInv text-danger font-italic"></h5>
          						<div class="row">
          						<div class="col-md-6">
				              <div class="form-group">
				                <input type="text" class="name form-control" name="name" placeholder="Họ và tên" value="<?php echo $_SESSION['login']['full_name'] ?>">
				              </div>
			              </div>
			              <div class="col-md-6">
				              <div class="form-group">
			              ...
			              <div class="col-md-6">
				              <div class="form-group">
				                <input type="text" class="form-control" name="email2" id="email" placeholder="Email" value="<?php echo $_SESSION['login']['email'] ?>">
				              </div>
			              </div>
			              <div class="col-md-6">
				              <div class="form-group">
			              ...
			              <div class="col-md-12">
			              	<div class="form-group">
			              		<textarea cols="30" rows="5" id="note" class="form-control" placeholder="Ghi chú"></textarea>
			              	</div>
			              </div>
			              <div class="col-md-6">
			           ...
			           <!--    <div class="col-md-12">
			              <div class="form-group">
			              	<label>Tổng thanh toán: <span class="total2"><?php echo number_format($totalPrice) ?></span></label>
			              </div>
			          </div> -->
          					...
          					<div class="modal-footer">
          						...
          						<button class="btn btn-primary xt-submit">Xác nhận đơn hàng</button>
          					</div>
          				</div><!-- /.modal-content -->
          			</div><!-- /.modal-dialog -->
          		</div>
          		...
          		<div id="myInvoices"  class="modal fade" tabindex="-1" role="dialog">
          			<div class="modal-dialog modal-lg" role="document">
			              ...
			              <div class="col-md-6">
				              <div class="form-group">
				                <input type="text" class="form-control" name="address" placeholder="Địa chỉ nhận món" >
				              </div>
			              </div>
			              <div class="col-md-12">
			              	<div class="form-group">
  ...
  <?php include_once './incfiles/footer-asset.php'; ?>
	<script language="javascript">
    		...
    		$(".quanlity").change(function(){
    			...
    			// for (var i = 0; i < <?php echo count($_SESSION['cart']) ?>; i++) {
    			// 	<?php foreach ($product as $value): ?>
    			// 		var pro = $("#quanlity<?php echo $value['id'] ?>").text();
    			// 		pro+=pro;
    			// 	<?php endforeach ?>    				
    			// }
    			// $(".total2").html(pro);

    			// var total = $(this).closest('.onRow').find('td:nth-child(6)').text();
    			// $(".total2").text(total);
    			//var pro = $("#quanlity<?php echo $value['id'] ?>").text();
    		});


    		$(".xt-submit").click(function(){
				var name = $("input[name='name']").val();
				var phone = $("input[name='phone']").val();
				var email2 = $("#email").val();
				var address = $("input[name='address']").val();
				var note = $("#note").val();
				var created_date = <?php date('d-m-Y H:i:s'); ?>
				$.post("customer.php", {name: name, phone: phone, email2: email2, address: address, note: note, created_date: created_date}, function(data){
					$(".errInv").html(data);
				});
			});
