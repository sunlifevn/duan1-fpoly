  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
       <form action="<?php echo ADMIN_URL ?>partner/save-add.php" method="post" id="addBrand" enctype="multipart/form-data">
         <div class="col-md-6">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-md-6 col-md-offset-3 text-left">
                <img id="showImage" src="<?php echo SITE_URL ?>img/default/default-picture.jpg" alt="" class="img-responsive" width="30%">
              </div>
            </div>
            <label>Ảnh</label>
 ...
 $(document).ready(function(){
  ...
  messages: {
    ...
    img.onchange = function(){
      ...
      if(anh == undefined){
        document.querySelector('#showImage').src = "<?php echo SITE_URL ?>img/default/default-picture.jpg";
      }else{
