  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
       <form action="<?php echo ADMIN_URL ?>product/save-edit.php" method="post" id="addProduct" enctype="multipart/form-data">
         ...
         <div class="col-md-6">
           <div class="form-group">
             <label>Tên món</label>
             <input type="text" name="name" class="form-control" value="<?php echo $product['product_name'] ?>" id="nameProduct" onkeyup="ChangeToSlug()">
             <?php 
           ...
           <div class="form-group">
              ...
              <input type="text" name="slug" class="form-control" id="slugProduct" value="<?php echo $product['slug'] ?>">
           ...
           <div class="form-group">
            ...
            ?>
              <option value="<?php echo $value['id'] ?>" <?php if ($value['id'] === $product['id']): ?>
                        selected
                      <?php endif ?>
          ...
          <?php } ?>
            ...
            <div class="form-group">
             <label>Giá</label>
             <input type="number" name="listPrice" class="form-control" value="<?php echo $product['price'] ?>">
           </div>
            
           <div class="form-group">
             <label>Giá km</label>
             <input type="number" name="sellPrice" class="form-control" value="<?php echo $product['sale_price'] ?>">
           </div>
            </div>
             <div class="col-md-6">
              <div class="row">
              <div class="col-md-6 col-md-offset-3">
                <img id="showImage" src="<?php echo SITE_URL . $product['thumbnail'] ?>" alt="" class="img-responsive">
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
             <label>Mô tả</label>
             <textarea name="desc" id="" cols="10" rows="5" class="form-control"><?php echo $product['detail_info'] ?></textarea>
           </div>
 ...
 <script>
  $(document).ready(function(){
    ...
    img.onchange = function(){
      ...
      if(anh == undefined){
        document.querySelector('#showImage').src = "<?php echo SITE_URL . $product['thumbnail']?>";
      }else{
